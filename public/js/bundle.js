...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWluZHJpdSIsImEiOiJjazd3MmFkcHcwaWxzM2htb204MGFyM28wIn0.qmQG0IKQ_f4ek6VzqZJPBA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_pgO0Tvfx2mIaXjgPhxPs6HqY00NuOz4OTJ');
            _context.next = 4;
